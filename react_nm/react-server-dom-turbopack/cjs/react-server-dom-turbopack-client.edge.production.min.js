...
function v(a){var b=__turbopack_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(c){b.status="fulfilled";b.value=c},function(c){b.status="rejected";b.reason=c});return b}function ba(){}
function ca(a){for(var b=a[1],c=[],d=0;d<b.length;d++){var e=b[d],g=u.get(e);if(void 0===g){g=__turbopack_load__(e);c.push(g);var f=u.set.bind(u,e,null);g.then(f,ba);u.set(e,g)}else null!==g&&c.push(g)}return 4===a.length?0===c.length?v(a[0]):Promise.all(c).then(function(){return v(a[0])}):0<c.length?Promise.all(c):null}
