...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactART = {}, global.React));
  ...
  var _ReactInternals$Sched = ReactInternals.Scheduler,
      ...
      log$2 = _ReactInternals$Sched.log,
      unstable_setDisableYieldValue$1 = _ReactInternals$Sched.unstable_setDisableYieldValue;

  // This module only exists as an ESM wrapper around the external CommonJS
  var scheduleCallback$3 = unstable_scheduleCallback;
  ...
  var IdlePriority = unstable_IdlePriority; // this doesn't actually exist on the scheduler, but it *does*
  // on scheduler/unstable_mock, which we'll need for internal testing

  var log$1 = log$2;
  var unstable_setDisableYieldValue = unstable_setDisableYieldValue$1;
  ...
  function createInstance(type, props, internalInstanceHandle) {
    ...
    switch (type) {
      case TYPES.CLIPPING_RECTANGLE:
        instance = current$1.ClippingRectangle();
        instance._applyProps = applyClippingRectangleProps;
        break;

      case TYPES.GROUP:
        instance = current$1.Group();
        instance._applyProps = applyGroupProps;
        break;

      case TYPES.SHAPE:
        instance = current$1.Shape();
        instance._applyProps = applyShapeProps;
        break;

      case TYPES.TEXT:
        instance = current$1.Text(props.children, props.font, props.alignment, props.path);
  ...
  function requirePath$2 () {
  	if (hasRequiredPath$2) return path$2;
  	hasRequiredPath$2 = 1;
  	var Class = _class;
  ...
  var shape$1;
  var hasRequiredShape$1;

  function requireShape$1 () {
  	if (hasRequiredShape$1) return shape$1;
  	hasRequiredShape$1 = 1;
  	var Class = _class;
  ...
  var group$1;
  var hasRequiredGroup$1;

  function requireGroup$1 () {
  	if (hasRequiredGroup$1) return group$1;
  	hasRequiredGroup$1 = 1;
  	var Class = _class;
  	var Container = requireContainer();
  	var Node = requireNode$1();

  	group$1 = Class(Node, Container, {
  ...
  var clippingrectangle$1;
  var hasRequiredClippingrectangle$1;

  function requireClippingrectangle$1 () {
  	if (hasRequiredClippingrectangle$1) return clippingrectangle$1;
  	hasRequiredClippingrectangle$1 = 1;
  	var Class = _class;
  	var Container = requireContainer();
  	var Node = requireNode$1();

  	clippingrectangle$1 = Class(Node, Container, {
  ...
  function requireShadow () {
  	...
  	hasRequiredShadow = 1;
  	var Class = _class;
  	var Dummy = requireDummy();
  	var Native = requireNative();

  	shadow = Class(Dummy, Native, {
  ...
  function requireNode () {
  	...
  	var Class = _class;
  	var Transform = transform;
  	var Element = requireShadow();
  	var DOM = requireDom();

  	node = Class(Element, Transform, {
  ...
  var hasRequiredClippingrectangle;

  function requireClippingrectangle () {
  	if (hasRequiredClippingrectangle) return clippingrectangle;
  	hasRequiredClippingrectangle = 1;
  	var Class = _class;
  	var Transform = transform;
  	var Container = requireContainer();
  	var Node = requireNode();

  	clippingrectangle = Class(Node, Container, {
  ...
  if (hasCanvas()) {
    fastNoSideEffects.Surface = requireSurface$1();
    fastNoSideEffects.Path = requirePath$1();
    fastNoSideEffects.Shape = requireShape$1();
    fastNoSideEffects.Group = requireGroup$1();
    fastNoSideEffects.ClippingRectangle = requireClippingrectangle$1();
    fastNoSideEffects.Text = requireText$1();
  } else {
    fastNoSideEffects.Surface = requireSurface();
    fastNoSideEffects.Path = requirePath();
    fastNoSideEffects.Shape = requireShape();
    fastNoSideEffects.Group = requireGroup();
    fastNoSideEffects.ClippingRectangle = requireClippingrectangle();
    fastNoSideEffects.Text = requireText();

    var DOM = requireDom();
    if (typeof document !== 'undefined') DOM.init(document);
  }

  current$1.setCurrent( // Change to 'art/modes/dom' for easier debugging via SVG
  fastNoSideEffects);
  ...
  var Surface = /*#__PURE__*/function (_React$Component) {
    ...
    _proto4.componentDidMount = function componentDidMount() {
      ...
      this._surface = current$1.Surface(+width, +height, this._tagRef);
    ...
    _proto4.render = function render() {
      ...
      var Tag = current$1.Surface.tagName;
