...
x.transition={};try{a()}finally{x.transition=b}};c.unstable_Activity=ia;c.unstable_Cache=ja;c.unstable_DebugTracingMode=ha;c.unstable_SuspenseList=da;c.unstable_act=function(a){throw Error("act(...) is not supported in production builds of React.");};c.unstable_getCacheForType=function(a){var b=w.current;return b?b.getCacheForType(a):a()};c.unstable_getCacheSignal=function(){var a=w.current;return a?a.getCacheSignal():(a=new AbortController,a.abort(Error("This CacheSignal was requested outside React which means that it is immediately aborted.")),
...
c.useState=function(a){return m.current.useState(a)};c.useSyncExternalStore=function(a,b,d){return m.current.useSyncExternalStore(a,b,d)};c.useTransition=function(){return m.current.useTransition()};c.version="18.3.0-experimental-07cc4a000-20231113"})})();
